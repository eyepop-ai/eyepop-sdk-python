...
class TestArrowToPandas(TestCase):
    def test_arrow_to_pandas(self):
        self._test_arrow_to_pandas(ASSET_SCHEMA_LATEST)

    def test_arrow_to_pandas_0_0(self):
        self._test_arrow_to_pandas(ASSET_SCHEMA_0_0)

    def test_arrow_to_pandas_1_0(self):
        self._test_arrow_to_pandas(ASSET_SCHEMA_1_0)

    def _test_arrow_to_pandas(self, schema: pa.Schema):
