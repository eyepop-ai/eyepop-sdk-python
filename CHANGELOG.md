...
### Fixed
- Transient compute workers now request an owned local pipeline from the Compute API with the Pop instead of adopting shared session pipelines or creating a pipeline in a second call.
